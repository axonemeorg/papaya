...
export default function DateFilter() {
    ...
    const dateFilter = isCustomDateView 
        ? currentDateFilter as CustomDateView 
        : defaultDateFilter;
    
    // Convert string dates to dayjs objects for the pickers
    const [afterDate, setAfterDate] = useState<dayjs.Dayjs | null>(
        dateFilter.after ? dayjs(dateFilter.after) : null
    );
    const [beforeDate, setBeforeDate] = useState<dayjs.Dayjs | null>(
        dateFilter.before ? dayjs(dateFilter.before) : null
    );
