        ...
        <Paper sx={(theme) => ({ borderRadius: theme.spacing(1) })}>
          ...
          {Object.values(getAccountsQuery.data).length === 0 ? (
            <Typography align="center" variant="body2" px={2} py={3}>
              No accounts.{' '}
              <MuiLink sx={{ pointer: 'cursor' }} onClick={() => setShowCreateAccountModal(true)}>
                Create one
              </MuiLink>
            </Typography>
          ) : (
                  ...
                  <ListItem
                    ...
                    secondaryAction={
                      <Stack direction="row" gap={1}>
                        <Button color="primary" onClick={() => handleSelectAccountForEdit(account)}>
                          Edit
                        </Button>
                        <Button color="error" onClick={() => handleDeleteAccount(account)}>
                          Delete
                        </Button>
                      </Stack>
                    }>
