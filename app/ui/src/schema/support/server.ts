...
export const CustomZiskServer = CloudZiskServer.merge(
  z.object({
...
export const ZiskServer = z.union([CustomZiskServer, NoneZiskServer, CloudZiskServer])
...
export const SyncingStrategy = z.union([LocalSyncingStrategy, ServerSyncingStrategy, CouchDbSyncingStrategy])
