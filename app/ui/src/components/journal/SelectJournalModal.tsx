    ...
    <>
      ...
      <Dialog open={showSelectJournalModal}>
        ...
        <List>
          {Object.values(journals).map((journal: Journal) => {
            ...
            return (
              <ListItem
                ...
                disablePadding>
                <ListItemButton role={undefined} onClick={() => setSelectedJournalId(journal._id)} selected={selected}>
                  <ListItemAvatar>
                    <Avatar>
          ...
          {Object.values(journals).length > 0 && <Divider component="li" />}
          <ListItem disablePadding>
            <ListItemButton onClick={() => setJournalSelectorStatus('CREATING')}>
              <ListItemAvatar>
                <Avatar>
                  <Add />
                </Avatar>
