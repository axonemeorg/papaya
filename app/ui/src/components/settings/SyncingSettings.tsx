...
import { __purgeAllLocalDatabases } from '@ui/database/actions'
import { useZiskMeta } from '@ui/hooks/queries/useZiskMeta'
import { SyncingStrategy } from '@ui/schema/support/server'
    ...
    <>
      ...
      <Stack gap={3}>
        ...
        <section>
          ...
          <Typography variant="body2" color="textSecondary" mb={2}>
            Zisk uses <Link href={POUCH_DB_DOCS_URL}>PouchDB</Link> to store your journals. If you are connected to a
