...
const AppLogo = () => (
    <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 131.1 121.01" style={{ height: 'auto', width: '1ch' }}>
    ...
    return (
        <Container maxWidth='md' disableGutters>
            <Typography variant='h3' component='h1'>
                <a style={{ color: 'inherit', textDecoration: 'none' }} href={link}>Papaya <SpanChip><AppLogo /></SpanChip></a> is the <a href={sourceCodeLink} style={{ color: 'inherit' }} target='_blank'>open-source</a> <SpanChip>🌐</SpanChip>, local-first <SpanChip>🏡</SpanChip> personal finance <SpanChip>💸</SpanChip> app.
            </Typography>
            <Button
                variant='contained'
                component='a'
